...
![alt text](<SS/Screenshot (255).png>)
Endpoint update jika format tanggal yang diisi tidak valid
![alt text](<SS/Screenshot (253).png>)
Endpoint delete data
![alt text](<SS/Screenshot (256).png>)
Enpoint search berdasarkan nama
![alt text](<SS/Screenshot (257).png>)
Endpoint search berdasarkan tanggal
![alt text](<SS/Screenshot (258).png>)
